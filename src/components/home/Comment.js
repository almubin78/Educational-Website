                ...
                <p>
                    {
                        user ? <>
                            ...
                            <p>এই প্রথম তোমার এলাকায় শুরু হতে যাচ্ছে Web + Offline Lecture ভিত্তিক নিম্নোক্ত বিষয় নির্ভর প্রাইভেট ব্যাচসমূহঃ</p>
                            <li>HSC  Physics-1</li>
                            <li>HSC  Physics-2</li>
                            <li>HSC  ICT</li>
                ...
                <p>
                    {
                        !user ?
                            <>
                                👈 পুর্বেই রেজিষ্টার প্রক্রিয়া সম্পন্ন করে থাকলে <Link className='underline text-purple-500' to='/register'>Login</Link> <span> 👈 লেখাটির উপর ক্লিক করে লগিন করে ফেল।</span>
                                <br />👉🏻 রেজিষ্টার না করে থাকলে <Link className='underline text-purple-500' to='/register'>Create an account</Link> <span> 👈 লেখাটির উপর ক্লিক করে রেজিষ্টার কর।</span> 
                            </> : <>
